  ...
  return (
    <div className="mx-auto w-full max-w-4xl px-4 py-8">
      <div className="mb-6 flex items-center justify-between">
        ...
        <Link href="/purchases/new" className="rounded bg-black px-3 py-2 text-sm text-white">
          New purchase
        </Link>
      </div>
      ...
      <Pagination page={page} pageSize={PAGE_SIZE} totalCount={count ?? 0} basePath="/purchases" />
    </div>
  );
}
