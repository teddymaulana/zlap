...
export default function GoogleSignInButton() {
  ...
  const handleClick = async () => {
    ...
    // Full-page redirect to Google, then to Supabase's own /auth/v1/callback,
    // then back to our app at /account/auth/callback?code=... — see that
    // route for the rest of the flow.
  ...
  return (
    <button
      ...
      className="flex items-center justify-center gap-2 rounded border border-gray-300 px-4 py-2.5 text-sm font-medium hover:bg-gray-50 disabled:opacity-50"
    >
