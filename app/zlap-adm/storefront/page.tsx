...
export default async function StorefrontSettingsPage() {
  ...
  const [
    ...
    supabase.from("storefront_shortcuts").select("*").order("position", { ascending: true }),
    getCardSets(),
  ]);
  ...
  const sectionConfigs = [
    {
      ...
      list: products
        ...
        .sort(
          (a, b) =>
            (a.featured_section_1_order ?? Infinity) - (b.featured_section_1_order ?? Infinity)
        ),
    },
    {
      ...
      list: products
        ...
        .sort(
          (a, b) =>
            (a.featured_section_2_order ?? Infinity) - (b.featured_section_2_order ?? Infinity)
        ),
    },
  ];
