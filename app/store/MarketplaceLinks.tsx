        ...
        <div className="flex items-center gap-4">
          ...
          >
            ...
            <div className="leading-tight">
              <div className="text-[10px] font-medium opacity-80">Find us on</div>
              <div className="text-sm font-bold">Shopee</div>
            </div>
          </a>
          <a
          ...
          >
            ...
            <div className="leading-tight">
              <div className="text-[10px] font-medium opacity-80">Find us on</div>
              <div className="text-sm font-bold">Tokopedia</div>
            </div>
          </a>
        </div>
      </div>
